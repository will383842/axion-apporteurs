 ...
 * PR #31 a ferme pour les CINQ gardes — celui qui rendait la garde d'argent VERTE sur ZERO
 * fichier dans un depot sans `.git`, depot PUBLIC.
 * *Une branche qui n'a pas vu passer un correctif le REINTRODUIT en silence : le merge prend
 * son cote partout ou elle est la plus riche, correctif compris.*
 */
