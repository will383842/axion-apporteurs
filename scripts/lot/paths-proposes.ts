...
const MANUELS: Record<string, string[]> = {
  ...
  'GOV-004': ['docs/VERIFICATIONS-AXIONIA.md'],
  ...
  'GOV-011': ['docs/TRACEABILITE.md', 'scripts/plan-state/traceabilite.ts'],
  ...
  'GOV-020': ['docs/VERIFICATIONS-AXIONIA.md'],
...
function construire() {
  ...
  const resume = {
    _methode:
      ...
      'chaîne — la comparaison exacte que fait `scripts/lot/composer.ts` (`pris.has(p)`). Ces trois ' +
