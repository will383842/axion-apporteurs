...
// l'etape Tests (`tests/unit/ci/integration-collectee-par-gate-a.spec.ts`) ; et semgrep est livre par
// QA-T07, juge par `tests/unit/qualite/semgrep-regles-maison.spec.ts`. Le reste — audit, gitleaks,
// req:check, idor:check, lint de migration, size-limit (QA-T28) — n'est pas encore livre. Le dire ici
// vaut mieux que le laisser croire : c'est la case cochee sans etre
