...
export const CHAMPS: Champ[] = [
  ...
  {
    cle: 'entite.tvaIntracommunautaire',
  ...
  {
    cle: 'domaines.servi',
    libelle: 'domaine servi',
    reqs: ['REQ-CPL-017'],
    ancre: { source: 'decisions', id: 'W3' },
    secret: false,
    env: null,
    identifiant: true,
  },
  {
    cle: 'domaines.envoi',
    libelle: 'sous-domaine d’envoi des courriels',
    reqs: ['REQ-CPL-017'],
    ancre: null,
    secret: false,
    env: null,
  ...
  {
    cle: 'perimetre.modeleTetesDeReseau',
    libelle: 'modèle des têtes de réseau',
    reqs: ['REQ-CPL-003'],
    ancre: { source: 'decisions', id: 'W4' },
    secret: false,
    env: null,
    identifiant: false,
  },
  {
    cle: 'perimetre.residenceFiscaleExigee',
    libelle: 'résidence fiscale exigée de l’apporteur',
    reqs: ['REQ-CPL-004'],
    ancre: { source: 'exigences', id: 'REQ-CPL-004' },
    secret: false,
    env: null,
    identifiant: false,
  },
  {
    cle: 'perimetre.tenance',
    libelle: 'modèle de tenance',
    reqs: ['REQ-CPL-018'],
    ancre: { source: 'exigences', id: 'REQ-CPL-018' },
    secret: false,
    env: null,
    identifiant: false,
  },
  ...
  {
    cle: 'banqueDebitrice.iban',
    libelle: 'IBAN débiteur',
    reqs: ['REQ-CPL-001'],
    ancre: null,
    secret: true,
    env: 'PARTNERS_IBAN_DEBITEUR',
    identifiant: true,
  },
  {
    cle: 'banqueDebitrice.bic',
    libelle: 'BIC débiteur',
    reqs: ['REQ-CPL-001'],
    ancre: null,
    secret: true,
    env: 'PARTNERS_BIC_DEBITEUR',
    identifiant: true,
  },

  // REQ-CPL-002 — la banque réceptrice du pain.001.
  {
    cle: 'banqueReceptrice.versionPain001',
    libelle: 'version du schéma pain.001',
    reqs: ['REQ-CPL-002'],
    ancre: { source: 'decisions', id: 'HYP-W2' },
    secret: false,
    env: null,
    identifiant: false,
  },
  {
    cle: 'banqueReceptrice.modeDeRemise',
    libelle: 'mode de remise à la banque',
    reqs: ['REQ-CPL-002'],
    ancre: { source: 'decisions', id: 'HYP-W2' },
    secret: false,
    env: null,
  ...
  {
    cle: 'banqueReceptrice.bic',
    libelle: 'BIC de la banque réceptrice',
    reqs: ['REQ-CPL-002'],
    ancre: null,
    secret: false,
    env: null,
  ...
  {
    cle: 'banqueReceptrice.jeuDeCaracteres',
    libelle: 'jeu de caractères accepté',
    reqs: ['REQ-CPL-002'],
    ancre: null,
    secret: false,
    env: null,
  ...
  {
    cle: 'banqueReceptrice.espaceDeTest',
    libelle: 'espace de test de la banque',
    reqs: ['REQ-CPL-002'],
    ancre: null,
    secret: false,
    env: null,
  ...
  {
    cle: 'banqueReceptrice.formatReleveCsv',
    libelle: 'format CSV du relevé',
    reqs: ['REQ-CPL-002'],
    ancre: null,
    secret: false,
    env: null,
