...
`gov:attestation`, y sont inscrites par `hors-depot/ajouter-entree.mjs`, le verbe d'ajout né le
...
`hors-depot/DETTE-DES-SUCCEDANES.md`, avec le geste unique qui les ferme.
