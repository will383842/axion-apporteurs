...
propriétaire de `champs.ts`. Le registre `docs/gates.json` et sa vue `docs/GATES.md` décrivent
encore l'ancienne portée (9 familles, 17 témoins, trois clés d'écriture) : c'est une dette de
prose, hors du droit d'écriture de cette tâche.
