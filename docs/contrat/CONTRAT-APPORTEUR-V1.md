...
<!-- Gabarit public, texte figé par la décision W11. Chaque variable entre doubles accolades est
     ...
     docs/contrat/ANNEXE-2-MANDAT.md ; la table de correspondance qui suit l'annexe 1 est une table
     technique : elle ne fait pas partie du document remis (texteRemis). -->
...
**{{SOCIETE}}**, {{FORME}} au capital de {{CAPITAL}}, immatriculée sous le
numéro SIREN {{SIREN_AXION}} (SIRET {{SIRET_AXION}}), numéro de TVA intracommunautaire {{TVA_AXION}}, dont le
siège est {{SIEGE}}, représentée par
{{REPRESENTANT}}, en qualité de Président, ci-après « **la Société** »,
...
## Annexe 1 — Grille de commissions du présent contrat, version `{{GRILLE_VERSION}}` <!-- CL-GRILLE -->

> **Générée** depuis la grille du présent contrat (`GrilleContrat`), arrêtée avant sa génération et
> **figée** à la signature. Elle n'est jamais retapée à la main. Une modification de la grille crée une
...
> publie (`COMMERCIAL_COMMISSIONS`, `src/content/pricing.ts`). **Seule la colonne « Commission du présent
...
| Gagner du temps | `intervention-temps` | 1 journée | {{PRIX_INTERVENTION_TEMPS}} | {{COM_INTERVENTION_TEMPS}} | {{PUBLIEE_INTERVENTION_TEMPS}} | {{CPF_INTERVENTION_TEMPS}} |
| Formation 4 heures | `intervention-4h` | demi-journée | {{PRIX_INTERVENTION_4H}} | {{COM_INTERVENTION_4H}} | {{PUBLIEE_INTERVENTION_4H}} ¹ | {{CPF_INTERVENTION_4H}} |
| Intervention Claude | `intervention-claude` | 1 journée | {{PRIX_INTERVENTION_CLAUDE}} | {{COM_INTERVENTION_CLAUDE}} | {{PUBLIEE_INTERVENTION_CLAUDE}} | {{CPF_INTERVENTION_CLAUDE}} |
| Essentielle — petit groupe | `essentielle-standard` | 1 journée | {{PRIX_ESSENTIELLE_STANDARD}} | {{COM_ESSENTIELLE_STANDARD}} | {{PUBLIEE_ESSENTIELLE_STANDARD}} | {{CPF_ESSENTIELLE_STANDARD}} |
...
*Grille publiée : `com-un-a-un` est **sur barème** — aucun montant n'y est publié. La valeur applicable est
...
| Dirigeant, format long | `intervention-dirigeant-vision-2j` | 2 jours | {{PRIX_INTERVENTION_DIRIGEANT_VISION_2J}} | {{COM_INTERVENTION_DIRIGEANT_VISION_2J}} | {{PUBLIEE_INTERVENTION_DIRIGEANT_VISION_2J}} | {{CPF_INTERVENTION_DIRIGEANT_VISION_2J}} |
| Collaborateur | `intervention-membre-equipe` | 1 jour | {{PRIX_INTERVENTION_MEMBRE_EQUIPE}} | {{COM_INTERVENTION_MEMBRE_EQUIPE}} | {{PUBLIEE_INTERVENTION_MEMBRE_EQUIPE}} | {{CPF_INTERVENTION_MEMBRE_EQUIPE}} |
| Collaborateur, format long | `intervention-membre-equipe-2j` | 2 jours | {{PRIX_INTERVENTION_MEMBRE_EQUIPE_2J}} | {{COM_INTERVENTION_MEMBRE_EQUIPE_2J}} | {{PUBLIEE_INTERVENTION_MEMBRE_EQUIPE_2J}} | {{CPF_INTERVENTION_MEMBRE_EQUIPE_2J}} |
...
| Audit ciblé | `audit-cible` | {{PRIX_AUDIT_CIBLE}} | {{COM_AUDIT_CIBLE}} | {{PUBLIEE_AUDIT_CIBLE}} | {{CPF_AUDIT_CIBLE}} |
| Audit ciblé — solo | `audit-cible-solo` | {{PRIX_AUDIT_CIBLE_SOLO}} | {{COM_AUDIT_CIBLE_SOLO}} | {{PUBLIEE_AUDIT_CIBLE_SOLO}} | {{CPF_AUDIT_CIBLE_SOLO}} |
| Audit ciblé — standard | `audit-cible-standard` | {{PRIX_AUDIT_CIBLE_STANDARD}} | {{COM_AUDIT_CIBLE_STANDARD}} | {{PUBLIEE_AUDIT_CIBLE_STANDARD}} | {{CPF_AUDIT_CIBLE_STANDARD}} |
| Audit ciblé — avancé | `audit-cible-avance` | {{PRIX_AUDIT_CIBLE_AVANCE}} | {{COM_AUDIT_CIBLE_AVANCE}} | {{PUBLIEE_AUDIT_CIBLE_AVANCE}} | {{CPF_AUDIT_CIBLE_AVANCE}} |
| Audit stratégique PME | `audit-strategique-pme` | {{PRIX_AUDIT_STRATEGIQUE_PME}} | {{COM_AUDIT_STRATEGIQUE_PME}} | {{PUBLIEE_AUDIT_STRATEGIQUE_PME}} | {{CPF_AUDIT_STRATEGIQUE_PME}} |
| Audit stratégique PME — 20 à 50 salariés | `audit-strategique-pme-20-50` | {{PRIX_AUDIT_STRATEGIQUE_PME_20_50}} | {{COM_AUDIT_STRATEGIQUE_PME_20_50}} | {{PUBLIEE_AUDIT_STRATEGIQUE_PME_20_50}} | {{CPF_AUDIT_STRATEGIQUE_PME_20_50}} |
| Audit stratégique PME — 50 à 250 salariés | `audit-strategique-pme-50-250` | {{PRIX_AUDIT_STRATEGIQUE_PME_50_250}} | {{COM_AUDIT_STRATEGIQUE_PME_50_250}} | {{PUBLIEE_AUDIT_STRATEGIQUE_PME_50_250}} | {{CPF_AUDIT_STRATEGIQUE_PME_50_250}} |
| Audit stratégique ETI | `audit-strategique-eti` | {{PRIX_AUDIT_STRATEGIQUE_ETI}} | {{COM_AUDIT_STRATEGIQUE_ETI}} | {{PUBLIEE_AUDIT_STRATEGIQUE_ETI}} | {{CPF_AUDIT_STRATEGIQUE_ETI}} |
| Audit stratégique ETI — base | `audit-strategique-eti-base` | {{PRIX_AUDIT_STRATEGIQUE_ETI_BASE}} | {{COM_AUDIT_STRATEGIQUE_ETI_BASE}} | {{PUBLIEE_AUDIT_STRATEGIQUE_ETI_BASE}} | {{CPF_AUDIT_STRATEGIQUE_ETI_BASE}} |

### A1.4 — Implémentations (5 paliers)

*Grille publiée : **{{PUBLIEE_TAUX_INTEGRATION}} du montant hors taxes facturé** (`com-integration`). Les quatre derniers paliers
...
| Mission ETI | `impl-mission-eti` | {{PRIX_IMPL_MISSION_ETI}} | {{COM_IMPL_MISSION_ETI}} | {{PUBLIEE_IMPL_MISSION_ETI}} | {{CPF_IMPL_MISSION_ETI}} |
| Grand programme | `impl-grand-programme` | {{PRIX_IMPL_GRAND_PROGRAMME}} | {{COM_IMPL_GRAND_PROGRAMME}} | {{PUBLIEE_IMPL_GRAND_PROGRAMME}} | {{CPF_IMPL_GRAND_PROGRAMME}} |
| IA custom d'entreprise (4 à 12 semaines) | `impl-ia-custom` | {{PRIX_IMPL_IA_CUSTOM}} | {{COM_IMPL_IA_CUSTOM}} | {{PUBLIEE_IMPL_IA_CUSTOM}} | {{CPF_IMPL_IA_CUSTOM}} |
...
| Prestation | Identifiant | Commission |
| --- | --- | --- |
...
## Correspondance article ↔ identifiant de clause

> Table de vérité de la gate `GATE-JUR-CONTRAT-COMPLET` (`contract-template-complete.spec.ts`,
> `REQ-JUR-003`). Chaque identifiant est posé en commentaire HTML dans le titre de l'article qui le porte.

| Identifiant | Article(s) | Objet |
| --- | --- | --- |
| `CL-PORTEE` | 1.1 à 1.3 | Objet du contrat, absence d'obligation de signalement, absence de mandat, maîtrise de la relation commerciale exercée de bonne foi |
