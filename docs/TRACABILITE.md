...
270 tâches, dont 60 livrées · 79 fichiers de test exécutés par `vitest` sur 79 présents.
...
| `tests/unit/integration/recherche-entreprises-repli.spec.ts` | oui | `REQ-SEC-013`, `REQ-UX-020` |
