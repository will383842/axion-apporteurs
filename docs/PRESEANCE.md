...
| 14 | `docs/requirements.json` | `docs/REQUIREMENTS-ANNEXE-FUSIONS.md` | **A** | L'annexe consigne la fusion et son motif ; le texte que le code applique est le champ `texte` du registre — c'est lui, et lui seul, que lit `pnpm gov:requirements`. Les deux ont divergé jusqu'au 2026-09-19 : voir §5, point 3, et `partners/ADR-0016`. |
