...
**Tests.** `tests/unit/gouvernance/vues-derivees.spec.ts` · `tests/unit/gouvernance/refus-de-rendre-et-de-publier.spec.ts` · `tests/unit/gouvernance/tete-de-pr-concorde.spec.ts` · `tests/unit/gouvernance/revues-lecteur-unique.spec.ts`
