...
**288 taches · 218.35 j estimes.**

| Phase | Taches | Jours | Terminees |
| --- | ---: | ---: | ---: |
| -1 — Gouvernance (prealable bloquant) | 39 | 23.75 | 39 |
| 0 — Socle technique | 114 | 87.85 | 35 |
...
`1 j` · zone `integration` · sensible : rgpd · depend de `SEC-06`, `INT-T01c`, `SEC-03`, `DM-06`
...
`1.5 j` · zone `espace` · `schema` · sensible : attribution, espace, rgpd · depend de `DM-07`, `DM-08`, `SEC-05`, `UX-P0-01`, `UX-P1-05`
