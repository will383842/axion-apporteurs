...
| `aucun-annee-de-naissance` | INT-T09 | `scripts/gates/aucun-annee-de-naissance.ts` | — | pnpm securite:annee-naissance:prove — (INT-T09, 2026-09-19) 4 familles, 4 temoins derives du rendu reel d'une fixture enregistree, 1 contre-temoin : « 🔴 [cle_interdite] une réponse de bac portant la liste des dirigeants / [cle_interdite] bac (dirigeants) : champ `dirigeants` (.dirigeants) » ; « 🔴 [cle_interdite] une réponse de bac portant une année de naissance / [cle_interdite] bac (année) : champ `annee_de_naissance` (.suggestions[0].annee_de_naissance) » ; « 🔴 [valeur_de_personne] une année de naissance glissée sous un champ admis / … au champ .suggestions[0].codePostal » ; « 🔴 [perimetre_vide] 19 fixture(s) lue(s), il en faut au moins 20 » ; « 🟢 contre-témoin : les 22 fixtures enregistrées ». Binaire : `pnpm securite:annee-naissance -- --reponse <f>` sur chacune des deux reponses de bac sort en 1 et nomme le champ, `pnpm securite:annee-naissance` sur le depot sort en 0 (tests/unit/integration/recherche-entreprises-repli.spec.ts, REQ-SEC-013) |
