...
| HYP-W15-FILLEULS-VUE | « Mes filleuls » : ce que le parrain voit (W15, point 1) | La liste des filleuls **directs** porte, pour chacun, le **prénom**, l'**initiale du nom** et l'**état du contrat** parmi `signature_en_cours` et `signe` **seulement** ; un filleul dont le contrat a pris fin **sort de la liste** — le parrain n'apprend pas la fin d'une relation (`HYP-W15-ART-4-6`, tranchée le 2026-09-25). Jamais l'e-mail, le téléphone, un identifiant interne, `actif`/`dormant`, un compteur ni une date d'activité ; **aucun montant par filleul** (REQ-UX-041, REQ-UX-006 amendée) | paramètre | 2 | — | — |
| HYP-W15-ART-4-6 | Art. 4.6 al. 6 du gabarit face à la liste des filleuls (W15, point 1) | **Le gabarit est AMENDÉ** (décision de Will du 2026-09-25, « fais selon tes recommandations ») : l'al. 6 autorise au parrain la **liste de ses filleuls directs**, réduite au prénom, à l'initiale du nom et à l'état du contrat parmi `signature_en_cours` et `signe` **seulement** ; l'état `termine` n'est **jamais** montré, le filleul dont le contrat a pris fin sort de la liste. Aucun montant par filleul, aucune donnée d'activité, aucun second niveau — inchangé. Rédaction portée par JUR-T01 ; texte définitif soumis à la relecture de Will avant signature (JUR-T01b) | **avenant** | 2 | **premier DocuSeal** | **2026-09-25** |
...
| HYP-W15-NOTES | Notes internes et droit d'accès (W15, point 6) | Une note interne est une **donnée personnelle de l'apporteur** : jamais affichée dans l'espace, mais **incluse dans son export d'accès art. 15** (DM-20) ; rédaction factuelle ; conservée aussi longtemps que la fiche de l'apporteur (REQ-SEC-039) | paramètre | 3 | — | — |
