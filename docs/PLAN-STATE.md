...
| Qu’est-ce qui est en vol ? | 1. #84 (un contrôle requis rouge ou une revue manquante) · 2. #88 (un contrôle requis rouge ou une revue manquante) · 3. #89 (un contrôle requis rouge ou une revue manquante) · 4. #82 (un conflit avec `main`) · 5. #86 (un conflit avec `main`) |
| Qui tient quoi ? | QA-T08 (A05) · DM-02 (A05) · QA-T02 (A05) · QA-T03 (A05) · QA-T07 (A05) |
...
| Dernière entrée de journal | PR #86 — 2026-09-19 |
...
| 3 | #89 — fix(GOV-059): la revendication se derive de la forge, et gov:etat passe apres les etapes de mesure | `t/gov-059-titre` | un contrôle requis rouge ou une revue manquante |
