...
| Qu’est-ce qui est en vol ? | 1. #82 (un contrôle requis rouge ou une revue manquante) · 2. #88 (un contrôle requis rouge ou une revue manquante) · 3. #92 (un contrôle requis rouge ou une revue manquante) · 4. #122 (un contrôle requis rouge ou une revue manquante) · 5. #91 (un conflit avec `main`) · 6. #93 (un conflit avec `main`) |
...
| 4 | #122 — chore(GOV-098): perimetre fonctionnel decide par Will le 2026-09-25 — lignees, parrain, statistiques, bibliotheque | `t/perimetre-fonctionnel-2026-09-25` | un contrôle requis rouge ou une revue manquante |
