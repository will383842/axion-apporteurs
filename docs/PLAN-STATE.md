...
| Qu’est-ce qui est en vol ? | 1. #88 (rien) · 2. #112 (rien) · 3. #82 (un contrôle requis rouge ou une revue manquante) · 4. #92 (un contrôle requis rouge ou une revue manquante) · 5. #93 (un contrôle requis rouge ou une revue manquante) · 6. #102 (un contrôle requis rouge ou une revue manquante) · 7. #91 (un conflit avec `main`) · 8. #99 (un conflit avec `main`) |
...
| 6 | #102 — docs(GOV-063): ADR 0018 tranche l'homonymie, le nom gov:check est retire des deux cotes | `t/gov-check-homonymie` | un contrôle requis rouge ou une revue manquante |
