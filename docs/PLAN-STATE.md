...
**Aucune de ces dettes ne laisse fuir une coordonnée**, et l'attribution de la mesure compte : `securite` a fabriqué douze scénarios contre le code tel que livré et a balayé la population
entière du dépôt ; `mutation` a posé ses mutants et rejoué le banc de la porte A. Les dettes du
quatrième point viennent de `simplicite` et de `securite`, la cinquième de `mutation` — chacune
reprise et jugée sous la lentille de la sécurité, aucune mesurée par elle à l'origine.
