...
| Qu’est-ce qui est en vol ? | 1. #107 (rien) · 2. #108 (rien) · 3. #82 (un conflit avec `main`) · 4. #88 (un conflit avec `main`) · 5. #90 (un conflit avec `main`) · 6. #91 (un conflit avec `main`) · 7. #92 (un conflit avec `main`) · 8. #93 (un conflit avec `main`) · 9. #99 (un conflit avec `main`) · 10. #100 (un conflit avec `main`) · 11. #102 (un conflit avec `main`) |
...
| 2 | #108 — fix(GOV-088): le glossaire interdisait la colonne qu'il prescrit, et un .ts ne peut citer aucun terme interdit | `t/glossaire-enveloppe` | rien — fusionnable maintenant |
