...
| Qu’est-ce qui est en vol ? | 1. #92 (rien) · 2. #88 (un contrôle requis rouge ou une revue manquante) · 3. #82 (un conflit avec `main`) · 4. #91 (un conflit avec `main`) · 5. #93 (un conflit avec `main`) |
...
**Fusionner #92** — elle est en tête de file et ne bloque sur rien.
