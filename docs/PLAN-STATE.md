...
| Qu’est-ce qui est en vol ? | 1. #36 (rien) · 2. #39 (rien) · 3. #44 (rien) · 4. #45 (rien) · 5. #41 (un contrôle requis rouge ou une revue manquante) |
...
| 3 | #44 — chore(GOV-031): l'outillage epingle, ses scripts, et les deux etapes de Gate A | `t/gov-031` | rien — fusionnable maintenant |
| 4 | #45 — fix(GOV-037): les attributions se confrontent a leurs sources — quatre rouges fermes, cliquet a 36 | `t/gov-037` | rien — fusionnable maintenant |
| 5 | #41 — feat(GOV-030): la garde des termes interdits que six documents invoquaient sans quelle existe | `t/gov-030` | un contrôle requis rouge ou une revue manquante |
