...
| Question | Réponse |
| --- | --- |
| Où est `main` ? | `53cf630` — 2026-09-23T00:14:52+02:00 |
| Qu’est-ce qui est en vol ? | 1. #82 (un conflit avec `main`) · 2. #88 (un conflit avec `main`) · 3. #90 (un conflit avec `main`) · 4. #91 (un conflit avec `main`) · 5. #92 (un conflit avec `main`) · 6. #93 (un conflit avec `main`) · 7. #99 (un conflit avec `main`) · 8. #102 (un conflit avec `main`) |
| Qui tient quoi ? | QA-T08 (A05) · QA-T07 (A05) · GOV-059 (A05) |
| Où en est la phase ? | phase 0 — 19/101 tâches, reste 62.60 j |
...
19/101 tâches terminées · reste 62.60 j estimés.
...
| `en_revue` | 0 | — |
| `fusionnee` | 58 | GOV-000, GOV-007, GOV-001, GOV-018, GOV-008, GOV-002, GOV-003, GOV-004, GOV-005, GOV-006, GOV-009, GOV-010 … |
| `deployee` | 0 | — |
| `verifiee` | 0 | — |
...
| 8 | #102 — docs(GOV-063): ADR 0017 tranche l'homonymie, le nom gov:check est retire des deux cotes | `t/gov-check-homonymie` | un conflit avec `main` — à résoudre avant tout |
...
`origin/main` = `53cf630` (2026-09-23T00:14:52+02:00). Vérifier `x-partners-build-sha` avant toute nouvelle fusion.
