...
| Qu’est-ce qui est en vol ? | 1. #82 (rien) · 2. #88 (rien) · 3. #92 (rien) · 4. #93 (rien) · 5. #99 (rien) · 6. #91 (un contrôle requis rouge ou une revue manquante) · 7. #102 (un contrôle requis rouge ou une revue manquante) · 8. #112 (un contrôle requis rouge ou une revue manquante) |
...
| 8 | #112 — fix(GOV-092): une revision servie sans `diff` bloque la porte A, et les deux remedes nommes sont faux | `t/gov-092` | un contrôle requis rouge ou une revue manquante |
