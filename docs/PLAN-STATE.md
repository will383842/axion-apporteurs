...
| Qu’est-ce qui est en vol ? | 1. #88 (rien) · 2. #92 (rien) · 3. #112 (rien) · 4. #82 (un contrôle requis rouge ou une revue manquante) · 5. #91 (un contrôle requis rouge ou une revue manquante) · 6. #93 (un contrôle requis rouge ou une revue manquante) · 7. #99 (un contrôle requis rouge ou une revue manquante) · 8. #102 (un contrôle requis rouge ou une revue manquante) |
...
| 7 | #99 — feat(GOV-047): pnpm prevol existe enfin, derive du job gate-a et non de la chaine gov:check | `t/gov-047` | un contrôle requis rouge ou une revue manquante |
