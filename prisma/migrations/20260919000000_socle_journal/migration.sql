-- Socle du schéma Partners et journal Evenement — DM-01 (partners/ADR-0013).
...
-- SQL brut : Prisma ne modélise ni CHECK, ni fonction, ni déclencheur (partners/ADR-0013).
